...
public class WaterMark {
    private static final String FILEINPUT = "D:\\source.jpg";
    private static final String FILEMARK = "D:\\mark.jpg";
    private static final String FILEDEST1 = "D:\\文字水印效果.jpg";
    private static final String FILEDEST2 = "D:\\图像水印效果.jpg";
    ...
    public static void main(String args[]) {
        WaterMark wmObj = new WaterMark();
        //文字水印
        if (wmObj.createStringMark(FILEINPUT, "三亚(SanYa)", Color.red, 7)) {
            System.out.println("生成文字水印成功。请查看当前目录下的" + FILEDEST1);
        } else {
            System.out.println("生成文字水印失败！");
        }
        //图像水印
        if (wmObj.createWaterMarkDemo(FILEINPUT, 3)) {
